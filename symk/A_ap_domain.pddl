...
(define (domain pr2-tamp)
   ...
   (:predicates
          ...
          (isgrasp ?o - wuti ?p - pose ?g - grasp ?a - arm)
          (isarm ?a - arm ?o - wuti ?p1 - pose ?p2 - pose)
          (kin ?o - wuti ?p - pose ?g - grasp ?a - arm ?t - trajectory)
          (on ?o - wuti ?r - wuti)
          (graspable ?o - wuti)
   ...
   (:action pick
          ...
          :precondition (and (atpose ?o ?p) (kin ?o ?p ?g ?a ?t) (on ?o ?r) (clear ?o) (canpick) (graspable ?o))
   ...
   (:action place
          ...
          :precondition (and (kin ?o ?p ?g ?a ?t) (smaller ?o ?r) (clear ?r) (atgrasp ?o ?g ?a) (atpose ?r ?rp) (issupport ?o ?p ?r ?rp))
