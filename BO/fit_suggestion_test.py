...
def suggest_from_data(data_by_ctype, idxsInput_by_ctype, bi_by_ctype, fix_by_input=None, range_by_input=None):
    """
...
if __name__ == '__main__':
    ...
    #
    # inputs_next, info_by_input = suggest_from_data(data_by_ctype, idxs_by_ctype, bi_by_ctype, fix_by_input,
    #                                                range_by_input)
    # print(inputs_next)
    ...
    for i, (boInput, boOutput) in enumerate(list_input_output):
        ...
        if i > 0 and inputs_next[0][0]==2:
            ...
            if list_x:
                ...
                # Creating plot
                ax.scatter3D(list_x, list_y, list_r, color="green")
                ax.set_xlim3d(0, 1)
                ax.set_ylim3d(0, 1)
                ax.set_zlim3d(0, 1)
