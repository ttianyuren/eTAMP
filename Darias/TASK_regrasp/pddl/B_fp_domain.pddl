...
(define (domain pick-and-place_propo)
   ...
   (:action a0_locate_body
          ...
          :effect (and (located o10 p832) (not (allowlocate)) (increase (total-cost) 50) (not (_applicable _p0)) (_applicable _p1))
   )
   (:action a1_move_free
   ...
   (:action a2_pick
          ...
          :effect (and (atgrasp o10 #g0) (canmove) (not (atpose o10 p832)) (not (handempty)) (increase (total-cost) 100) (not (_applicable _p2)) (_applicable _p3))
   )
   ...
   (:action s8_sample-grasp
          ...
          :effect (and (graspatpose #g0 p832) (isgrasp o10 #g0))
   )
   ...
   (:action s12_inverse-kinematics
          ...
          :effect (and (isconf #q0) (istraj #t1) (iskin o10 p832 #g0 #q0 #t1))
   )
   ...
   (:action s17_inverse-kinematics
          :parameters (o10 p832 #g1)
          :precondition (and (ispose o10 p832) (isgrasp o10 #g1))
          :effect (and (isconf #q4) (istraj #t6) (iskin o10 p832 #g1 #q4 #t6))
   )
   (:action s18_inverse-kinematics
          :parameters (o10 p832 #g2)
          :precondition (and (ispose o10 p832) (isgrasp o10 #g2))
          :effect (and (isconf #q5) (istraj #t7) (iskin o10 p832 #g2 #q5 #t7))
   )
   (:action s19_inverse-kinematics
          :parameters (o10 p832 #g3)
          :precondition (and (ispose o10 p832) (isgrasp o10 #g3))
          :effect (and (isconf #q6) (istraj #t8) (iskin o10 p832 #g3 #q6 #t8))
   )
