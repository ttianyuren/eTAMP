...
from utils.pybullet_tools.pr2_primitives import BodyPose, Conf, get_ik_ir_gen, get_motion_gen, \
    ...
    sdg_sample_grasp, sdg_motion_base_joint, sdg_sample_grasp_hanoi, sdg_ik_arm, sdg_sample_place_hanoi, sdg_sample_arm, \
    sdg_ik_arm_hanoi
from utils.pybullet_tools.pr2_utils import get_arm_joints, ARM_NAMES, get_group_joints, get_group_conf
from utils.pybullet_tools.utils import WorldSaver, connect, get_pose, set_pose, get_configuration, is_placement_hanoi, \
...
def get_pddlstream_problem(scn):
    ...
    goal = ('and',
            ...
            # ('On', scn.bd_body['disc2'], scn.bd_body['peg2']),
            # ('On', scn.bd_body['disc1'], scn.bd_body['disc2']),
            )
    ...
    stream_info = {'sample-arm': StreamInfo(seed_gen_fn=sdg_sample_arm(scn)),
                   ...
                   #                          free_generator=True, discrete=True, p1=[0, 1]),
...
def main(new_problem=1):
    ...
    skeleton_env = SkeletonEnv(e_root.num_children, op_plan,
                               ...
                               stream_info, scn)
    selected_branch = PlannerUCT(skeleton_env, pw_const=5, ucb_const=0.001)

    concrete_plan = selected_branch.think(500, 1)
