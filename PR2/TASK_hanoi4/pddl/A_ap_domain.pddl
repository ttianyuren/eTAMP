...
(define (domain pr2-tamp)
   ...
   (:action pick
          ...
          :effect (and (increase (total-cost) 100) (not (on ?o ?r)) (clear ?r) (not (canpick)) (atgrasp ?o ?g ?a) (not (atpose ?o ?p)))
   )
   (:action place
          ...
          :effect (and (increase (total-cost) 100) (on ?o ?r) (not (clear ?r)) (canpick) (not (atgrasp ?o ?g ?a)) (atpose ?o ?p))
   )
)
